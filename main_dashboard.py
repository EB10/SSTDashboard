...
def main():
    ...
    with st.expander("Tidslinje over begivenheder og smitteudvikling"):
        st.markdown('<div class='font-size: 25px;'>Her kan du se og navigere rundt i data - benyt menuen til venstre for at filtrere. Du kan zoome ind på en periode i graferne enten ved at markere området i grafen eller ved at filtrere på datoer i menuen til venstre.</div>', unsafe_allow_html=True)
