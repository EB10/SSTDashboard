...
def main():
    ...
    with st.expander("Introduktion", expanded=False):
        st.markdown("""
            ...
            <span style="font-size:20px;"><b>Sådan bruger du tidslinjen</b></span><br>
            ...
            <b>1. Filtrer efter emner og betydning</b><br>Alle begivenheder og udgivelser er inddelt efter emne og betydning.<br>
            ...
            <b>2. Zoom på datoer</b><br> Du kan zoome ind på specifikke datoer ved at ændre på datointervallet til en særlig tidsperiode ved brug af felterne <b>Startdato</b> og <b>Slutdato</b> i menuen til venstre for tidslinjen.<br>
            ...
            <b>3. Nulstil visningen</b><br>For at nulstille visningen og dermed dine valg af filtre for at se alle data igen, kan du klikke på <b>Genstart visningen</b> øverst til venstre på siden.<br><br>
            <b>4. Statistik på dagsniveau</b><br>Under tidslinjen fremgår en graf, der viser udvalgte statistikker på dagsniveau i samme periode som i tidslinjen. I feltet <b>Vælg statistik på dagsniveau</b> i menuen til venstre for tidslinjen har du mulighed for at vælge, hvilke statistikker du ønsker inkluderet i grafen.<br><br>
            <b>5. Søg efter specifikke begivenheder og udgivelser</b><br>Ønsker du et mere detaljeret indblik i specifikke begivenheder eller udgivelser, kan du anvende søgefeltet i fanen <b>Søg efter begivenheder og udgivelser.</b><br>
    ...
    with st.expander("Søg efter begivenheder og udgivelser"):
        ...
        if search_term:
            ...
            if not search_term_df.empty:
                ...
                st.dataframe(search_term_df, hide_index=True, use_container_width=True)
            else:
